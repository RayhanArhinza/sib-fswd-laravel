      ...
      <div class="col-md-6">
        <div class="card card-transparent" style="border-radius: 20px;">
          <div class="card-body">
            ...
            <p class="text-center mt-3">Don't have an account? <a href="<?php echo e(url('signup')); ?>">Sign up</a></p>
...
</html><?php /**PATH C:\laragon\www\arkatama-laravel\resources\views/admin/loginadmin.blade.php ENDPATH**/ ?>