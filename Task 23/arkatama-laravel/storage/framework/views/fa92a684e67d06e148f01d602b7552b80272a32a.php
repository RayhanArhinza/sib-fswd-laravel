        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="<?php echo e(url('dashboard')); ?>" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">ZenBook</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="layouts-without-menu.html" class="menu-link menu-toggle ">
                  ...
                  <ol class="menu-sub"  >
                    <li class="menu-item">
                      <a href="layouts-without-menu.html" class="menu-link" >
                        <div data-i18n="biografi" >Biografi</div>
                      </a>
                      
                    </li>
                    <li class="menu-item">
                      <a href="layouts-without-navbar.html" class="menu-link">
                        <div data-i18n="novel">Novel</div>
                      </a>
                    </li>
                    <li class="menu-item">
                    ...
                    <li class="menu-item">
                      <a href="layouts-fluid.html" class="menu-link">
                        <div data-i18n="Fluid">majalah</div>
                      </a>
                    </li>
                  </ol>
                </li>
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-account-settings-account.html" class="menu-link">
                    <div data-i18n="Account">Group Pengguna</div>
                  </a>
                </li>
                <li class="menu-item">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row">
                    <div class="col mt-4 order-0">
                        ...
                        <div class="card">
                            <h5 class="card-header">Daftar Buku <i class='bx bxs-book'></i></h5>
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Rayhan Saneval Arhinza</a>
                </div>
                <div>
...
<?php /**PATH C:\laragon\www\arkatama-laravel\resources\views/admin/produk.blade.php ENDPATH**/ ?>